...
class Config(object):
    ...
    API_ID = os.environ.get("API_ID", "24314601")
    API_HASH = os.environ.get("API_HASH", "ede341e2d490a0fad5469866dedf8a95")
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "6498608614:AAFu84eh-eQCn8l75GDcbQ9xblRHkGhBCFg") 
    ...
    DB_URL = os.environ.get("DB_URL","mongodb+srv://rename:rename@rename.s2n5fka.mongodb.net/?retryWrites=true&w=majority&appName=rename")
 
    # other configs
    RKN_PIC = os.environ.get("RKN_PIC", "https://telegra.ph/file/b746aadfe59959eb76f59.jpg")
    ADMIN = [int(admin) if id_pattern.search(admin) else admin for admin in os.environ.get('ADMIN', '1058015838').split()]
    LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1001652564383"))
